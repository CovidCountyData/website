  ...
  const datasets = [
    {
      ...
      url: `${BASE_URL}/all_current_date_latest.csv`,
      description:
    ...
    {
      name: "All (historical)",
      url: `${BASE_URL}/all_timeseries_latest.csv`,
      description:
